...
import { Moon, Sparkles, ShieldCheck, ArrowLeft, Star } from "lucide-react";
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 bg-[#050508] relative overflow-hidden font-sans selection:bg-amber-500/30 selection:text-amber-200">
      ...
      <div className="absolute inset-0 bg-[#020617] z-0">
        ...
        <div className="absolute top-[-20%] left-[-10%] w-[60vw] h-[60vw] bg-indigo-900/30 rounded-full blur-[150px] pointer-events-none mix-blend-screen animate-pulse-slow"></div>
        <div className="absolute bottom-[-20%] right-[-10%] w-[50vw] h-[50vw] bg-amber-900/20 rounded-full blur-[150px] pointer-events-none mix-blend-screen animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-[30%] left-[50%] w-[40vw] h-[40vw] bg-violet-900/20 rounded-full blur-[150px] pointer-events-none mix-blend-screen animate-pulse" style={{ animationDelay: '4s' }}></div>
      ...
      {/* Center Form Card */}
      <div className="w-full max-w-md bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[2.5rem] shadow-[0_0_80px_rgba(0,0,0,0.8)] relative z-10 overflow-hidden animate-in fade-in slide-in-from-bottom-8 duration-700 p-8 sm:p-10 group/card hover:border-white/20 transition-colors duration-500">
        ...
        <div className="flex flex-col items-center mb-8 relative z-10">
          ...
          <p className="text-slate-400 text-sm font-medium text-center">
            Log in to continue the learning journey.
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-white/5 text-center">
          <Link 
            to="/admin-login"
            className="inline-flex items-center justify-center gap-2 text-xs font-bold text-slate-500 hover:text-indigo-400 transition-colors px-4 py-2 rounded-lg hover:bg-indigo-500/10 group/admin"
          >
